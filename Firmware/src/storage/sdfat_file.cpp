...
SdFat_WrappedFile::SdFat_WrappedFile(FsFile file, store_fd fileDesc, SdFat_Store &store, FILE_MODE mode, size_t maxQueueSize) : WrappedFile(store, fileDesc, mode, maxQueueSize),
                                                                                                                                _file(file)
{
}
